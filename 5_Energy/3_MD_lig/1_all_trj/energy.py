...
def compute_energy(pdb_lig, pdb_rec):
    ...
    crdl = read_crd(os.path.join("../../../2_super_CA/3_ligand/pdb", pdb_lig))
...
def main():
    pdb_lig_dir = '../../../2_super_CA/3_ligand/pdb'
